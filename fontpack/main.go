...
func main() {
	...
	for _, font := range fontConfig.Fonts {
		img := util.ReadImage(font.Name + ".png")
		...
		for y, str := range font.Letters {
			...
			for _, chr := range str {
				bmfont.Chars.Count++
				rightMargin := util.GetRightMargin(img, x*font.Size, y*font.Size, font.Size, font.Size)
				topMargin := util.GetTopMargin(img, x*font.Size, y*font.Size, font.Size, font.Size)
				bottomMargin := util.GetBottomMargin(img, x*font.Size, y*font.Size, font.Size, font.Size)
